...
// ActivityProduct - Product (一对一，用于直接查询)
ActivityProduct.belongsTo(Product, { 
  foreignKey: 'product_id', 
  as: 'product' 
})
Product.hasMany(ActivityProduct, { 
  foreignKey: 'product_id', 
  as: 'activityProducts' 
})

// ActivityProduct - Activity (一对一，用于直接查询)
ActivityProduct.belongsTo(Activity, { 
  foreignKey: 'activity_id', 
  as: 'activity' 
})
Activity.hasMany(ActivityProduct, { 
  foreignKey: 'activity_id', 
  as: 'activityProducts' 
})
